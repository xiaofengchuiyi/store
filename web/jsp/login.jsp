            ...
            <div style="width:440px;border:1px solid #E7E7E7;padding:20px 0 20px 30px;border-radius:5px;margin-top:60px;background:#fff;">
                ...
                <form class="form-horizontal" action="${pageContext.request.contextPath}/UserServlet?method=login" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="username" class="form-control" id="username" placeholder="请输入用户名"
                                   value="${cookie.remembermeCookie.value}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <%--     style="cursor: pointer"  末尾没有;--%>
                            <img id="imgSignCode" src="${pageContext.request.contextPath}/CodeServlet" style="cursor: pointer" title="重新获取"
...
<script type="text/javascript">
    function changeImg(img){
        img.src="${pageContext.request.contextPath}/CodeServlet?method=picture&time="+new Date().getTime();
    }
    ...
    function reloadCode() {
        document.getElementById("imgSignCode").src="${pageContext.request.contextPath}/CodeServlet?method=picture&time="+new Date().getTime() ;
