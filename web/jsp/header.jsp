...
<script type="text/javascript">
	$(function () {
	    //向服务端CategoryServlet getAllCats发起ajax请求，服务器经过处理
	    ...
	    $.post(url,obj,function (data) {
	        $.each(data,function (i,n) {
	            //支持分页，如果没有传递默认值
	            $("#menu").append("<li><a href='${pageContext.request.contextPath}/ProductServlet?method=findByCid&cid="+n.cid+"'>"+n.cname+"</a></li>");
            })
        },"json")
